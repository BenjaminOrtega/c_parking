...
/**
 * The Class IteratorPersona.
 */
public class IteratorPersona implements Iterator{
	
	/** The agregado. 
	 * Variable de tipo Agergado concreto, en donde se tiene la lista*/
	private AgregadoConcretoPersona agregado;
